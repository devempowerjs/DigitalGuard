    ...
    >
      <div className="space-y-8">
        ...
        <div className="relative w-full h-64 rounded-lg overflow-hidden">
          {/* MANAGE PAGE IMAGE FIX: Commented out Unsplash source that may be blocked by school networks */}
          {/* Original Unsplash image: https://images.unsplash.com/photo-1599350686877-382a54114d2f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwcHJpdmFjeSUyMG1hbmFnZW1lbnR8ZW58MXx8fHwxNzU4ODgyMDk2fDA&ixlib=rb-4.1.0&q=80&w=1080 */}
          {/* <ImageWithFallback
          ...
          {/* NEW: CSS-based privacy management illustration */}
          <div className="w-full h-full bg-gradient-to-r from-green-500 via-teal-600 to-blue-600 flex items-center justify-center relative overflow-hidden">
            <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
            <div className="text-center text-white z-10 p-6">
              ...
              <h3 className="text-xl font-semibold opacity-90">Privacy Management</h3>
              <p className="text-sm opacity-75 mt-2">Take Control of Your Data</p>
            </div>
          </div>
        </div>
